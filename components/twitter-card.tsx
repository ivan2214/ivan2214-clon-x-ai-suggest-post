              ...
              <section className="w-3/4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    ...
                    {tweet.retweets > 0 && <span className="ml-1 text-sm">{tweet.retweets}</span>}
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    {tweet.likes > 0 && <span className="ml-1 text-sm">{tweet.likes}</span>}
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    {tweet.plays > 0 && <span className="ml-1 text-sm">{tweet.plays}</span>}
                  </div>
                </div>
              </section>
